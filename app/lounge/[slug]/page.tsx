  ...
  return (
    <div className="min-h-screen bg-pattern pb-32 md:pb-12">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="bg-white rounded-3xl p-6 border-2 border-slate-900 shadow-hard">
              <div className="flex flex-wrap items-center gap-2 mb-3">
                ...
                {(gig.city || gig.district) && <span className="bg-slate-100 text-slate-600 px-3 py-1 rounded-lg text-[10px] font-bold border border-slate-200 flex items-center gap-1"><i className="fa-solid fa-location-dot text-red-500"></i> {gig.district ? `${gig.district}, ` : ''}{gig.city}</span>}
          ...
          <div className="md:col-span-1">
            <div className="sticky top-24 bg-white rounded-3xl p-6 border-2 border-slate-900 shadow-hard">
              ...
              <div className="space-y-3">
                ...
                <button onClick={handleChat} disabled={chatLoading} className="w-full py-3 bg-white text-slate-900 rounded-xl font-bold border-2 border-slate-900 text-sm hover:bg-slate-50 transition flex items-center justify-center gap-2">
                  {chatLoading ? <i className="fa-solid fa-spinner fa-spin"></i> : <>Chat Dulu <i className="fa-regular fa-comment-dots text-lg"></i></>}
                </button>
              </div>
      ...
      <div className="md:hidden fixed bottom-0 left-0 w-full bg-white border-t-2 border-slate-900 p-4 z-50 flex items-center gap-3 pb-8">
        <button onClick={handleChat} disabled={chatLoading} className="flex-1 py-3 bg-white text-slate-900 rounded-xl font-bold border-2 border-slate-900 text-sm hover:bg-slate-50 transition flex items-center justify-center">
          {chatLoading ? <i className="fa-solid fa-spinner fa-spin"></i> : <i className="fa-regular fa-comment-dots text-xl"></i>}
        </button>
