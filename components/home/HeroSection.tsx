...
const HeroSection = () => {
  ...
  return (
    <header className="pt-24 pb-12 px-4 md:px-6 relative max-w-7xl mx-auto overflow-hidden min-h-[85vh] flex items-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <Link 
              href="/lounge" 
              className="w-full sm:w-auto bg-accent text-slate-900 px-8 py-4 rounded-xl font-black hover:bg-accent-hover transition border-2 border-slate-900 btn-brutal text-base uppercase tracking-wide shadow-hard flex items-center justify-center gap-2"
            >
              Jelajahi Lounge <i className="fa-solid fa-rocket"></i>
            </Link>
            <Link 
              href="/how-to" 
              className="w-full sm:w-auto bg-white text-slate-900 px-8 py-4 rounded-xl font-bold hover:bg-slate-50 transition border-2 border-transparent hover:border-slate-900 text-base text-center"
            >
              Cara Main
            </Link>
          </motion.div>
