  ...
  return (
    <footer className="bg-slate-900 text-white py-8 mt-auto border-t-4 border-accent">
      <div className="max-w-7xl mx-auto px-6 flex flex-col items-center text-center">
        ...
        {/* Logo */}
        <Link href="/" className="mb-3 opacity-90 hover:opacity-100 transition-opacity inline-block relative h-8 w-28">
            <Image 
               src="/logodark.svg" 
               alt="JASURD Logo" 
               fill
        ...
        {/* Tagline */}
        <p className="text-slate-400 text-[10px] md:text-xs max-w-xs font-medium mb-6 leading-relaxed">
          Platform gig economy buat lo yang punya skill absurd. <br className="hidden md:block"/>
